...
<html lang="zxx">
    ...
    <body>
        ...
        <div id="titulo" class="card" style="width: 50%; margin-left: 25%; margin-top: 5%" >
            <div class="card-body">
                <h2 style="margin-left: 30%">Historial de compra</h2>
            </div>
        </div>

        <table class="table table-striped" style="width: 50%; margin-left: 25%; margin-bottom: 10%">
            <tr class="table-dark">                             
                <td>Producto</td>
