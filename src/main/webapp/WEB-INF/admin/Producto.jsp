    ...
    <body>
        ...
        <div class="container">
            <div class="row flex-lg-nowrap">
                ...
                <form action="Grabar" method="post" enctype="multipart/form-data" style="width: 50%; margin-left: 20%">
                    <%
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nombre" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="${comida.getNombre()}">

                    </div>
                    <div class="mb-3">
                        <label for="exampleInputPassword1" class="form-label">Descripcion</label>
                        <input type="text" name="descripcion" class="form-control" id="exampleInputPassword1" value="${comida.getDescripcion()}">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputPassword1" class="form-label">Precio</label>
                        <input type="text" name="precio" class="form-control" id="exampleInputPassword1" value="${comida.getPrecio()}">
                    </div>
                    <%
