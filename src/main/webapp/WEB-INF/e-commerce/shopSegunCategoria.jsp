                                            ...
                                            <table>
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="si-close">
                                                            <a href="eliminarDelCarrito?idcomida=<%=comida.getIdcomida()%>&pathJSP=shopSegunCategoria"><i class="ti-close"></i></a>
                                                        </td>
                                                    </tr>
                                                    <%
                                                            }
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 order-1 order-lg-2">
                        ...
                        <div class="product-list">
                            <div class="row">
                                <%
                                    ArrayList<Comida> comidasPorCategoria = (ArrayList<Comida>) request.getAttribute("comidasPorCategoria");
                                    for (Comida c : comidasPorCategoria) {
                                %>
                                    ...
                                    <div class="product-item">
                                        ...
                                        <div class="pi-pic">
                                            ...
                                            <ul>
                                                ...
                                                <li class="w-icon active"><a href="agregarCarrito?idcomida=<%=c.getIdcomida()%>&pathJSP=shopSegunCategoria"><i class="icon_bag_alt"></i></a></li>
