...
<html lang="zxx">
    ...
    <head>
        <meta charset="UTF-8">
        <meta name="description" content="La cabañita Template">
        <meta name="keywords" content="La cabañita, unica, creative, html">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta http-equiv="X-UA-Compatible" content="ie=edge">
        <title>La cabañita - pedido en línea</title>
    ...
    <body>
        ...
        <section class="hero-section">
            <div class="hero-items owl-carousel" style="background: white">
                <div class="single-hero-items set-bg" data-setbg="img/hero-causa.jpeg">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-5">

                                <h1>Causa limeña</h1>
                                <p><%=ComidaDAO.mostrarComidaSegunId(64).getDescripcion()%></p>
                                <a href="detallesProducto?idcomida=64" class="primary-btn">Pedir ahora</a>
                            </div>
                        </div>

                    </div>
                </div>
                <div class="single-hero-items set-bg" data-setbg="img/hero-ceviche.png">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-5">

                                <h1>Ceviche</h1>
                                <p><%=ComidaDAO.mostrarComidaSegunId(67).getDescripcion()%></p>
                                <a href="detallesProducto?idcomida=67" class="primary-btn">Pedir ahora</a>
                            </div>
                        </div>

                    </div>
                </div>
                <div class="single-hero-items set-bg" data-setbg="img/hero-chorito.png">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-5">

                                <h1>Chorito a la chalaca</h1>
                                <p><%=ComidaDAO.mostrarComidaSegunId(68).getDescripcion()%></p>
                                <a href="detallesProducto?idcomida=68" class="primary-btn">Pedir ahora</a>
                            </div>
                        </div>

                    </div>
                </div>
                <div class="single-hero-items set-bg" data-setbg="img/hero-leche.png">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-5">

                                <h1>Leche de tigre</h1>
                                <p><%=ComidaDAO.mostrarComidaSegunId(65).getDescripcion()%></p>
                                <a href="detallesProducto?idcomida=65" class="primary-btn">Pedir ahora</a>
                            </div>
                        </div>

                    </div>
                </div>
                <div class="single-hero-items set-bg" data-setbg="img/hero-parihuela.png">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-5">

                                <h1>Parihuela</h1>
                                <p><%=ComidaDAO.mostrarComidaSegunId(87).getDescripcion()%></p>
                                <a href="detallesProducto?idcomida=87" class="primary-btn">Pedir ahora</a>
                            </div>
                        </div>
        ...
        <div class="banner-section spad">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="single-banner">
                            <img src="img/guarniciones.png" alt="">
                            <div class="inner-text">
                                <h4>Guarniciones</h4>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4" style="margin-top: 40px;">
                        <div class="single-banner">
                            <img src="img/platosextras.jpg" alt="">
                            <div class="inner-text">
                                <h4>Platos extras</h4>
                            </div>
                        </div>
