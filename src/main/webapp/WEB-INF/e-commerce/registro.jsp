                                            ...
                                            <table>
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="si-close">
                                                            <a href="eliminarDelCarrito?idcomida=<%=comida.getIdcomida()%>&pathJSP=registro"><i class="ti-close"></i></a>
                                                        </td>
                                                    </tr>
                                                    <%
                                                            }
                    ...
                    <div class="col-lg-6 offset-lg-3">
                        <div class="register-form">
                            ...
                            <form action="registrarCliente" method="post">
                                ...
                                <div class="group-input">
                                    <label for="conclave">Confirmar clave *</label>
                                    <input type="password" name="conclave">
                                </div>
                            ...
                            <div class="switch-login">
                                <a href="login" class="or-login">O ingresa</a>
                            </div>
                        </div>
                    </div>
                </div>
